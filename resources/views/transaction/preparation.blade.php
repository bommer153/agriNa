      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h6 class="title">{{__("Preparing Orders")}}</h6>
          </div>
          <div class="card-body"> 
                            ...
                            <div id="details{{ $ord->id }}" class='details' style='display:none'>
                                ...
                                <table class="table">
                                    ...
                                    <tfooter>
                                        ...
                                        <tr>          
                                            <td colspan="3">
                                                  <form action="{{ route('transaction.endorse',['transaction'=>$ord->transactionNumber]) }}" method='post'>
                                                        @method('PUT')
                                                        @csrf
                                                        ...
                                                        <button onclick="return confirm('accept?')" class='btn btn-primary btn-round'>Endorse</button>
                                                    </form>
